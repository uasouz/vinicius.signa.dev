...
export const HERO_TEXT = {
  ...
  tagline: "I enjoy creating and delivering digital products that make people's lives easier.",
  description: "I'm a Software Developer with knowledge in multiple languages and platforms, who had the opportunity to work in various areas of software development, from mobile to backend, and have also led great development teams.",
}
...
export const CONTACT_TEXT = {
  shortDescription: "I'm always open to discussing new opportunities or interesting projects.",
  longDescription: "I'm always open to discussing new opportunities, interesting projects, or just having a chat about technology. Feel free to reach out!",
}
